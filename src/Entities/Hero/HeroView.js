import { Container, Graphics, TilingSprite } from "../../../lib/pixi.mjs";
...
export default class HeroView extends Container {
    ...
    showStay() {
        this.#toState("stay");
        this.#bulletPointShift.x = (65 + this.#rootNode.pivot.x * this.#rootNode.scale.x) * this.#rootNode.scale.x;
        this.#bulletPointShift.y = 30;
    }
